  ...
  class DatabaseRestApiGet
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DatabaseRestApiGet` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DatabaseRestApiGet`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'parameters_schema')
        self.parameters_schema = attributes[:'parameters_schema']
      end
    ...
    def list_invalid_properties
      ...
      if @sqlalchemy_uri.nil?
        invalid_properties.push('invalid value for "sqlalchemy_uri", sqlalchemy_uri cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sqlalchemy_uri.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parameters_schema == o.parameters_schema &&
    ...
    def hash
      [allow_ctas, allow_cvas, allow_dml, allow_file_upload, allow_multi_schema_metadata_fetch, allow_run_async, backend, cache_timeout, configuration_method, database_name, encrypted_extra, expose_in_sqllab, extra, force_ctas_schema, id, impersonate_user, is_managed_externally, parameters, parameters_schema, server_cert, sqlalchemy_uri].hash
    end
