  ...
  class ChartDataRestApiPost
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ChartDataRestApiPost` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ChartDataRestApiPost`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @datasource_id.nil?
        invalid_properties.push('invalid value for "datasource_id", datasource_id cannot be nil.')
      end

      if @datasource_type.nil?
        invalid_properties.push('invalid value for "datasource_type", datasource_type cannot be nil.')
      end

      if @slice_name.nil?
        invalid_properties.push('invalid value for "slice_name", slice_name cannot be nil.')
      end
    ...
    def valid?
      return false if @datasource_id.nil?
      return false if @datasource_type.nil?
      ...
      return false if @slice_name.nil?
      true
    end
    ...
    def hash
      [cache_timeout, certification_details, certified_by, dashboards, datasource_id, datasource_name, datasource_type, description, external_url, is_managed_externally, owners, params, query_context, query_context_generation, slice_name, viz_type].hash
    end
